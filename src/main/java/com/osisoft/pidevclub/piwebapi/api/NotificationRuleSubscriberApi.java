...
public class NotificationRuleSubscriberApi {
	 ...
	 *
	 */
	public PINotificationRuleSubscriber getNotificationRuleSubscriberByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PINotificationRuleSubscriber> resp = getNotificationRuleSubscriberByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PINotificationRuleSubscriber> getNotificationRuleSubscriberByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getNotificationRuleSubscriberByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PINotificationRuleSubscriber>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getNotificationRuleSubscriberByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PINotificationRuleSubscriber> callback) throws ApiException {
		...
		okhttp3.Call call = getNotificationRuleSubscriberByPathCall(path, selectedFields, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getNotificationRuleSubscriberByPathCall(String path, String selectedFields, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
	 ...
	 *
	 */
	public PINotificationRuleSubscriber getNotificationRuleSubscriber(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PINotificationRuleSubscriber> resp = getNotificationRuleSubscriberWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PINotificationRuleSubscriber> getNotificationRuleSubscriberWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getNotificationRuleSubscriberCall(webId, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PINotificationRuleSubscriber>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 *
	 */
	public okhttp3.Call getNotificationRuleSubscriberAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PINotificationRuleSubscriber> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = getNotificationRuleSubscriberCall(webId, selectedFields, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getNotificationRuleSubscriberCall(String webId, String selectedFields, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
