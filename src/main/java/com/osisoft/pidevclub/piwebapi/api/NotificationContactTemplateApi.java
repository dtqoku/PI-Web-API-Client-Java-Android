...
public class NotificationContactTemplateApi {
	 ...
	 *
	 */
	public PINotificationContactTemplate get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PINotificationContactTemplate> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PINotificationContactTemplate> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getCall(webId, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PINotificationContactTemplate>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PINotificationContactTemplate> callback) throws ApiException {
