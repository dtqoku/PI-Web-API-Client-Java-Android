...
public class PIItemsNotificationRule {
	...
	private List<PINotificationRule> items = null;
	...
	public void setItems(List<PINotificationRule> items) { this.items = items;}

	public List<PINotificationRule> getItems() { return this.items;}
