...
public class PIExtendedTimedValues {
	...
	private List<PIExtendedTimedValue> items = null;
	...
	public void setItems(List<PIExtendedTimedValue> items) { this.items = items;}

	public List<PIExtendedTimedValue> getItems() { return this.items;}
