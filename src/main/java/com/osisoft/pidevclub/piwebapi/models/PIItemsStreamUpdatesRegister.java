...
public class PIItemsStreamUpdatesRegister {
	...
	private List<PIStreamUpdatesRegister> items = null;
	...
	public void setItems(List<PIStreamUpdatesRegister> items) { this.items = items;}

	public List<PIStreamUpdatesRegister> getItems() { return this.items;}
