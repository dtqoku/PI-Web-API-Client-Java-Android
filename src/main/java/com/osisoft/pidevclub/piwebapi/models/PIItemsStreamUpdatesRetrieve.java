...
public class PIItemsStreamUpdatesRetrieve {
	...
	private List<PIStreamUpdatesRetrieve> items = null;
	...
	public void setItems(List<PIStreamUpdatesRetrieve> items) { this.items = items;}

	public List<PIStreamUpdatesRetrieve> getItems() { return this.items;}
